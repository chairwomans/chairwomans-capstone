...
#### 최종 정리 및 면담 준비
1. 이전 확정 파이프라인에 confidence 추가 및 벤치마크 테스트 진행
   - 성능 향상 확인 <img width="641" height="362" alt="image (10)" src="https://github.com/user-attachments/assets/b82cb78b-7448-4d24-9a12-080e9fbb4b80" />
2. 금일 교수님 면담 준비
   - 스타트 때 만든 방법론 폐기 & 새로운 방법론 설명
   - 논문 작성 논의
   - 최종 목표 설정

#### 2026 2학기 학술활동 지원사업 공모 ####
1. 교수님 추천서 초안 작성
2. 연구계획서 작성
3. 지원서 작성
   - OpenCV 국제 대회 연계하여 참가
